...
class WordCloud {
	...
	public $papers = array();
	public $numPapers; 
	public $wordCloudImageFile = 'wordcloud.txt'; 
	...
	function generateCloud2(IEEE $IEEE) {
		$papers = getResults(null, $this->query, $IEEE);
		// foreach($papers as $paper) {
		// 	$p = implode('', $paper); 
		// 		echo '<script> console.log("Paper title: ' . $p . '"); </script> ';
	...
	function getDownloadFile() {
		return $this->wordCloudImageFile; 
	}

	function getPaperListWhenWordIsClicked($query) {
		return $this->papersRelatedToQuery; 
	}
